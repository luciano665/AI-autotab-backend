...
app.post('/api/chat', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, message, _b, context, messages, result, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _a = req.body, message = _a.message, _b = _a.context, context = _b === void 0 ? {} : _b;
                if (!message) {
                ...
                return [4 /*yield*/, (0, gemini_1.getGeminiResponse)(messages)];
            case 1:
                result = _c.sent();
            ...
            case 2:
                error_1 = _c.sent();
                console.error('Error in chat endpoint', error_1);
